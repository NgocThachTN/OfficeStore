...
public class AuthenFilter implements Filter {
    ...
    public AuthenFilter() {
        ...
        ADMIN_RESOURCE.add("adminProduct.jsp");
        ...
        NON_AUTHEN_RESOURCE.add("ViewController");
        NON_AUTHEN_RESOURCE.add("SearchController");
        NON_AUTHEN_RESOURCE.add("SearchProductController");
        NON_AUTHEN_RESOURCE.add("DeleteProductController");
        NON_AUTHEN_RESOURCE.add("UpdateProductController");
    }    
